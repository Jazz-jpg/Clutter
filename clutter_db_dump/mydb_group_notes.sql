...
CREATE TABLE `group_notes` (
  `idGROUP_NOTES` int NOT NULL,
  `idGROUP_NAME` varchar(45) NOT NULL,
  `GN_DESCRIPTION` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`idGROUP_NOTES`,`idGROUP_NAME`),
  KEY `fk_GROUP_NOTES_GROUP1_idx` (`idGROUP_NAME`),
  CONSTRAINT `fk_GROUP_NOTES_GROUP1` FOREIGN KEY (`idGROUP_NAME`) REFERENCES `group` (`idGROUP_NAME`)
