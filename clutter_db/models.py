...
class Group(models.Model):
    ...
    idmanages = models.CharField(db_column='idMANAGES', max_length=45)  # Field name made lowercase.
    ...
    class Meta:
        managed = False
        db_table = 'group'
        unique_together = (('idgroup_name', 'idmanages'),)


class GroupEvents(models.Model):
    idgroup_events = models.CharField(db_column='idGROUP_EVENTS', primary_key=True, max_length=8)  # Field name made lowercase.
    idgroup_name = models.ForeignKey('Groups', models.DO_NOTHING, db_column='idGROUP_NAME')  # Field name made lowercase.
    gs_event_name = models.CharField(db_column='GS_EVENT_NAME', max_length=45, blank=True, null=True)  # Field name made lowercase.
    gs_date = models.DateField(db_column='GS_DATE')  # Field name made lowercase.
    ...
    class Meta:
        ...
        unique_together = (('idgroup_events', 'idgroup_name'),)


class GroupNotes(models.Model):
    idgroup_notes = models.IntegerField(db_column='idGROUP_NOTES', primary_key=True)  # Field name made lowercase.
    idgroup_name = models.ForeignKey(Group, models.DO_NOTHING, db_column='idGROUP_NAME')  # Field name made lowercase.
    ...
    class Meta:
        ...
        unique_together = (('idgroup_notes', 'idgroup_name'),)


class GroupScheduling(models.Model):
    idgroup_events = models.IntegerField(db_column='idGROUP_EVENTS', primary_key=True)  # Field name made lowercase.
    idgroup_name = models.ForeignKey(Group, models.DO_NOTHING, db_column='idGROUP_NAME')  # Field name made lowercase.
    gs_event_name = models.CharField(db_column='GS_EVENT_NAME', max_length=45, blank=True, null=True)  # Field name made lowercase.
...
class GroupTasks(models.Model):
    idgroup_tasks = models.IntegerField(db_column='idGROUP_TASKS', primary_key=True)  # Field name made lowercase.
    idgroup_name = models.ForeignKey(Group, models.DO_NOTHING, db_column='idGROUP_NAME')  # Field name made lowercase.
    ...
    class Meta:
        ...
        unique_together = (('idgroup_tasks', 'idgroup_name'),)
...
class Membership(models.Model):
    idgroup_name = models.OneToOneField(Group, models.DO_NOTHING, db_column='idGROUP_NAME', primary_key=True)  # Field name made lowercase.
    iduser = models.ForeignKey('User', models.DO_NOTHING, db_column='idUSER')  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'membership'
        unique_together = (('idgroup_name', 'iduser'),)
...
class Show(models.Model):
    ...
    show_completed = models.IntegerField(db_column='SHOW_COMPLETED', blank=True, null=True)  # Field name made lowercase.
